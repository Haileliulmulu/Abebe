...
function downloadCV() {
    var cvFilePath = 'imag/newcv.pdf';
    var cvFileName = 'newcv.pdf';
    downloadFile(cvFilePath, cvFileName);
}
function downloadRes() {
    var resFilePath = 'imag/Resume.pdf';
    var resFileName = 'Resume.pdf';
    downloadFile(resFilePath, resFileName);
}
function downloadcr() {
    var cvFilePath = 'imag/CCNA.pdf';
    var cvFileName = 'imag/CCNA.pdf';
    downloadFile(cvFilePath, cvFileName);
}